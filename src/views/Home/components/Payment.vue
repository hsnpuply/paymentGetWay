...
const card_number_icon = ref(null);
...
<template>
  <!-- Payment -->
  <div
    class="payment flex flex-col gap-4 bg-light_bg min-h-[100vh]"
    :class="{ 'min-h-[70vh] py-0': count_down_end }"
  >
    <div class="payment__header relative before:!h-28 before:md:!h-28 before:lg:!h-16">
      ...
      <div
        class="header_main bg-white rounded-xl duration-300 lg:mt-6 flex items-center justify-between px-4 py-3 md:container !mx-auto !w-[95%] md:!w-[90%] md:!max-w-[1072px]"
      >
        ...
        <div class="center_header_payment">
          ...
          >
            <div
              ...
              :class="{
                'bg-primary_bg_danger_color': minutes <= 3,
    ...
    <!-- end of session -->
    <div class="session_end_container" v-if="count_down_end">
      <div
        class="bg-white rounded-xl md:!max-w-[1072px] md:container !mx-auto !w-[95%] md:!w-[90%] p-4"
      >
        <div
        ...
        >
          <div class="flex flex-col items-center">
            <div class="text-center rounded-full py-4">
              <img
                src="../../../assets/images/error-icon-4.png"
                alt=""
                class="w-10 opacity-80 hover:opacity-100 duration-300"
              />
          ...
          <div dir="rtl" class="error_info text-primary_danger_color pb-4 pt-0 px-3">
            <p class="text-lg">
              در صورت کسر وجه از حساب شما، مبلغ مذکور طی
              {{ convertNumbersToPersian("72") }} ساعت به حساب شما عودت خواهد شد.
            </p>
          </div>
        </div>
      </div>
      <div
        v-if="count_down_end"
        dir="rtl"
        class="container mt-4 rounded-xl p-3 !mx-auto bg-white text-black_gray_text md:!max-w-[1072px]"
      >
        <h3 class="mb-2">توجه</h3>
        <p class="mb-2 text-base">
          در صورتی که طی 30 دقیقه، فروشنده تایید تحویل کالا یا خدمت را به شرکت سِپ اطلاع
          رسانی نکند، مبلغ کسر شده طی {{ convertNumbersToPersian("72") }} ساعت به حساب شما
          برگشت داده می‌شود.
        </p>
      </div>
    </div>
            ...
            >
              <div class="card_number flex flex-col w-full">
                ...
                <div class="input_card_number relative">
                  <Icon
                    @click="toggle_saved_cards"
                    ref="card_number_icon"
                  ...
                  />
                  <div
                    :class="{ 'h-[17.7rem]': saved_cards_status }"
                    class="cards_panel bg-white absolute top-[100%] rounded-2xl z-[999] left-0 w-full h-0 duration-300 overflow-hidden border-border_color"
                  >
                    <div
                      dir="ltr"
                      class="cards_field rounded-t-xl bg-white mb-2 h-[10rem] overflow-scroll overflow-x-hidden border-black"
                    >
                      <!-- v-for -->
                    ...
                    <div
                      class="action_buttons_panel flex flex-col gap-4 bg-lighter_bg rounded-lg py-4 text-primary px-3 mx-4 py-2"
                    >
                      <div class="add_a_card flex gap-4 cursor-pointer">
                        <Icon
                          icon="ic:baseline-credit-card"
                          width="26"
                          height="26"
                          class="cursor-pointer text-xl text-primary_icon_light"
                        />
                        <p>افزودن کارت جدید</p>
                      </div>
                      <!-- manage cards -->
                      <div class="cars_managment flex gap-4 cursor-pointer">
                        <Icon
                          icon="ic:baseline-credit-card"
                          width="26"
                          height="26"
              ...
              <div class="cvv2 flex flex-col w-full">
                <label for="cvv2" class="mb-1"> شماره شناسایی دوم (CVV2) </label>
              ...
              <div class="security_code flex flex-col w-full mb-1">
                ...
                <div class="input_cvv2 relative flex gap-4">
                  ...
                  <div class="security_img flex items-start justify-center flex-col">
                    <img
                    ...
                    />
                    <div
                      class="play_security_code flex w-full justify-center items-center gap-1"
                    >
                      <div class="playsound pt-1">
                        <Icon
                          ...
                          width="20"
                          height="20"
                          class="cursor-pointer text-primary_icon"
                        />
                      </div>
              ...
              <div class="pin2 flex flex-col w-full">
                ...
                <!-- Action Buttons -->
                <div class="flex items-center justify-center flex-col my-2 gap-3">
                  <button
                ...
                >
                  ...
                  <div
                    class="flex items-start flex-col gap-1 cursor-pointer"
                    @click="toggle_payment_report"
                  >
                    <p>مایلید اطلاعات پرداخت را به صورت ایمیل و پیامک دریافت کنید؟</p>
                    <span>(اختیاری)</span>
                  </div>
                </div>
                <div
          ...
          <div class="merchent relative mt-2">
            <div class="beneficiary px-2 flex flex-col gap-6">
              <div class="merchent_store flex items-center gap-4 relative">
                ...
                <div class="store_name flex flex-col gap-2 pr-10">
                  ...
                  <h3 class="text-black_gray_text text-2xl font-semibold leading-4">
                    طـاقـچـه
                  </h3>
                </div>
              </div>
              ...
              <div class="merchent_store flex items-center gap-4 relative">
                ...
                <div class="store_name flex flex-col pr-10">
                  ...
                  <span class="text-light_gray text-sm">چهل و هشت هزار تومان</span>
                </div>
              </div>
            </div>
            <div
              :class="[
                more && currentWidth <= 768 ? 'h-40 lg:h-0 ' : 'overflow-hidden',
                currentWidth > 768 ? '!overflow-visible' : '',
              ]"
            ...
            >
              <div class="terminal_id flex items-center gap-2 relative">
                ...
                <div class="store_name flex flex-col pr-10">
                  <span class="text-light_gray text-sm">شماره پذیرنده / ترمینال</span>
              ...
              <div class="merchant_website flex items-center gap-2 relative">
                ...
                <div class="store_name flex flex-col pr-10">
                  ...
                  <h3 class="text-black_gray_text text-lg font-semibold">taaghche.com</h3>
                </div>
              </div>
            </div>
          </div>
    ...
    <div
      ...
      class="guide_dynamic_pin md:container !w-[95%] md:!w-[90%] duration-300 !px-0 rounded-lg my-8 text-right flex flex-col p-4 md:!max-w-[1072px] container mx-auto bg-white h-20 md:h-full overflow-hidden"
      dir="ltr"
    >
      <div
      ...
      <div class="description p-4">
        ...
        <p>
          .مرحله دوم: رمز پویا را بر اساس روش اعلامی از طرف بانک صادر کننده کارت، به یکی
          از روش‌های زیر دریافت کنید
        </p>
        <div class="step_2_steps flex items-end flex-col gap-2 px-8 py-2">
          ...
          <p>
            .مرحله سوم: پس از دریافت رمز به یکی از روش‌های فوق، رمز پویای دریافت شده را در
            محل تعیین شده برای "رمز دوم" وارد نمایید و سپس مابقی اطلاعات را تکمیل نمایید
          </p>
        </div>
      </div>
    </div>
    ...
    >
      <div
        class="title_security_guide mx-4 text-primary bg-lighter_bg p-4 rounded-lg relative"
      >
        <h2 class="text-sm mx-4">راهنما و نکات امنیتی</h2>
        <Icon
          :class="{ 'rotate-180': state.toggle.guide_security_toggle }"
          @click="toggle_guide_security"
          icon="ic:baseline-keyboard-arrow-down"
          width="24"
          height="24"
          class="cursor-pointer duration-300 md:hidden absolute left-0 bottom-0 mx-4 translate-y-[-50%]"
        />
      </div>
      ...
      <div class="description flex flex-col gap-2 p-4">
        ...
        <h3 class="flex w-full items-end justify-end gap-1">
          <p>
            .شماره شناسایی کارت با طول ۳ یا ۴ رقم کنار شماره کارت و یا پشت کارت درج شده
            است
          </p>
        ...
        <h3 dir="rtl" class="text-right">
          ...
          <span>
            با عنوان رمز دوم و در برخی موارد با PIN2 شناخته می‌شود، از طریق بانک صادر
            کننده کارت تولید شده و همچنین از طریق دستگاه‌های خودپرداز بانک صادر کننده قابل
            تهیه و یا تغییر می‌باشد.
          </span>
        </h3>
        <h3 dir="rtl" class="text-right">
          <span class="bold"> کد امنیتی : </span>
          <span>
            بخشی از محتوای صفحه پرداخت است و لازم است برای ادامه فرآیند خرید، کد موجود که
            به صورت عددی در تصویر مشخص شده است در محل پیش بینی شده درج شود.
          </span>
        </h3>

        <div dir="rtl" class="mt-3 about_us">
          <p>
            درگاه پرداخت اینترنتی سامان با استفاده از پروتکل امن SSL به مشتریان خود ارائه
            خدمت نموده و با آدرس
            <a href="https://sep.shaparak.ir" class="text-primary_danger_color">
              <span>https://sep.shaparak.ir</span>
            </a>
            شروع می‌شود. خواهشمند است به منظور جلوگیری از سوء استفاده‌های احتمالی پیش از
            ورود هرگونه اطلاعات، آدرس موجود در بخش مرورگر وب خود را با آدرس فوق مقایسه
            نمایید و در صورت مشاهده هر نوع مغایرت احتمالی، موضوع را با ما در میان بگذارید.
          </p>
        </div>
        <p>از صحت نام فروشنده و مبلغ نمایش داده شده، اطمینان حاصل فرمایید.</p>

        <p>
          برای جلوگیری از افشای رمز کارت خود، حتی المقدور از صفحه کلید مجازی استفاده
          فرمایید.
        </p>
  ...
  <div class="fixed bottom-10 right-10 z-20">
    <div class="bg-gray-800 text-white rounded-full w-16 p-4 text-xl md:hidden">SM</div>
    <div
